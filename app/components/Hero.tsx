  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#0a0a0f]">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
        ...
        <motion.h1
          className="mb-5 text-7xl font-extrabold tracking-tight md:text-8xl"
        ...
        <motion.p
          className="mb-5 text-2xl font-semibold leading-snug text-slate-200 md:text-3xl"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <motion.p
          className="mx-auto mb-12 max-w-3xl text-base leading-relaxed text-slate-400 md:text-lg"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
